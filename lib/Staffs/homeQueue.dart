...
class homeQueuePage extends StatefulWidget {
  @override
  homeQueuePageState createState() => homeQueuePageState();
  final String text1;
  // receive data from the FirstScreen as a parameter
  homeQueuePage({Key key, @required this.text1 }) : super(key: key);
}

// ignore: camel_case_types
class homeQueuePageState extends State<homeQueuePage> {
  Future<Counters> futureCounter;

  String countername = 'A1';
